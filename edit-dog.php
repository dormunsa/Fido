...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <li class="nav-item">
            <a class="nav-link sides"  href="add-dog.php">Add Dog</a>
            </li>
            <li class="nav-item">
            <a class="nav-link sides" id="side1" href="#">Delete Dog</a>
         </li>
         <li class="nav-item">
            <a class="nav-link sides" id="selectedNav" href="#">Edit Dog</a>
         </li>
            ...
            <h4 id="peronalDeta"> Personl Details </h4>
             ...
             <h4 id="appearence"> Apperance </h4>
              ...
              <section class="container Details" id="habit">
                ...
                <article class="row"></article>
                    <article class="row">
                        <p id="sucss" class="formLabeles col-xl-12 col-md-12">Update Succssed</p>
                    ...
                    <article class="row">
                        <p id="added" class="formLabeles col-xl-12 col-md-12">Your Dog Has Details Been Updated</p>
                    </article>
                    <article class="row">
  ...
  <script src="includes/js/edit-dog.js" async></script>
</body>
</html>
